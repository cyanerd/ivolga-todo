...
<main class="main">
  <div class="container">
    <?if(empty($arResult['BASKET']['BASKET_ITEMS'])):?>
      <div class="checkout-content" style="justify-content: center;">
        <h1 class="title-1">Корзина пуста</h1>
        <p>Добавьте товары для оформления заказа</p>
      </div>
      <? return false; ?>
    <?endif;?>
    <h1 class="title-1" style="margin-bottom:32px;">Оформление заказа</h1>
    <div class="checkout-content checkout-content--styled">
      <div class="checkout-config-container">
        ...
        <div class="checkout-config active">
          <button class="configuration">
            <div class="configuration-head">
              <h2 class="title-2">Адрес и доставка</h2>
        ...
        <div class="checkout-config">
          <button class="configuration">
            <div class="configuration-head">
              <h2 class="title-2">Получатель</h2>
              <div class="configuration-head__icon"></div>
            </div>
          </button>
          <div style="opacity: 1; transform: none;">
