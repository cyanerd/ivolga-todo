...
<main class="broadcast-content container">
    <div class="broadcast">
        <div class="broadcast-poster">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/3tndOnnA9Lw?si=adWMG6vfkiMXcVeM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <li class="products-card--small"><a class="products-card__link" href="product.html"><img
                            ...
                            <div class="products-card__colors"><div class="products-card-color-small"><div></div></div></div>
