...
$description = Loc::getMessage('WIDGET_DESC', [
...
?>
  ...
  <div>
    <p><?= Loc::getMessage('SUCCESS_MESSAGE', ["#ORDER_ID#" => $order->getId(), "#DATE#" => $order->getDateInsert()]) ?></p>
    <p><?= Loc::getMessage('ORDER_NUMBER', ["#ORDER_ID#" => $order->getId()]) ?></p>
