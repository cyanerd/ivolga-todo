          ...
          <div class="order-methods hidden">
            <div class="order-methods__row">
              <label class="order-methods__item">
                <h2>Курьер</h2>
                <p>С примеркой 15 мин.</p>
                <h3>Цена в зависимости от расположения</h3>
                <input type="radio" name="method-delivery" checked>
              </label>
              <label class="order-methods__item">
                <h2>пункт выдачи СДЭК или почта России</h2>
                <h3>Цена в зависимости от размера заказа</h3>
                <input type="radio" name="method-delivery">
              </label>
              <label class="order-methods__item">
                <h2>Самовывоз из шоурума</h2>
