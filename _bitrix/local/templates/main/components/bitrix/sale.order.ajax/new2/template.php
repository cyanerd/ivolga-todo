  ...
  <form action="<?= POST_FORM_ACTION_URI ?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
    ...
    <div id="bx-soa-order" class="order__wrapper" style="opacity: 0">
      ...
      <div class="bx-soa order__row order-row">
        ...
        <div id="bx-soa-total-mobile" class="order__aside"></div>
        ...
        <?php
        if ($arParams['BASKET_POSITION'] === 'after' && false):
          ?>
          <!--	BASKET ITEMS BLOCK	-->
          <div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
            <div class="bx-soa-section-title-container">
        ...
        <div id="bx-soa-orderSave">
          ...
          <a href="javascript:void(0)" class="order-submit__button" data-save-button="true">
            <?= $arParams['MESS_ORDER'] ?>
          </a>
        </div>
      ...
      <!--	SIDEBAR BLOCK	-->
      <div id="bx-soa-total" class="order__aside">
        <div class="order-aside">
          <!--	BASKET ITEMS BLOCK	-->
          <div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
            <h2 class="order-aside__title">Ваш заказ</h2>
            <div class="order-aside__cart bx-soa-section-content"></div>
          </div>
          <table class="order-aside__table">
            <tbody class="bx-soa-cart-total"></tbody>
          </table>
        </div>
      </div>
    </div>
