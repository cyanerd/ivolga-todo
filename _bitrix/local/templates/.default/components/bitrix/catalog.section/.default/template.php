                  ...
                  <li class="products-card--big">
                    ...
                    <a class="products-card__link" href="/product/<?= $arItem['CODE'] ?>/"><img
                      ...
                      <div class="products-card-title--big">
                        <p
                          class="products-card-title__product"><?= $arItem['PROPERTIES']['NAIMENOVANIE_TOVARA_NA_SAYTE_ETIKETKE']['VALUE'] ?? $arItem['NAME'] ?></p>
                        <p class="products-card-title__price"><?= number_format($arPrice['PRICE']['PRICE'], 0, '', ' ') ?>
                          ₽</p></p>
                      </div>
                    </a>
                    <?
                    ...
                    <div class="products-card__colors">
                      <? foreach ($colors as $color => $detail_page_url): ?>
                        <div
                          class="products-card-color-small<? if ($arItem['PROPERTIES']['TSVET']['VALUE'] == $color) echo ' __active' ?>">
