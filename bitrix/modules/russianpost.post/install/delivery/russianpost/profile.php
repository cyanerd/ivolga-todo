	...
	protected function calculateConcrete(\Bitrix\Sale\Shipment $shipment = null)
	{
		...
		if(!empty($shipment))
		{
			...
			if($this->calculateId != $idCalculatedDelivery || $this->calcPrice != $orderPrice
				|| ($deliveryPrice == 0 && isset($_SESSION['russianpost_post_calc']['price']) && $_SESSION['russianpost_post_calc']['price']>0
					&& $_SESSION['russianpost_post_calc']['checked_delivery'] == $this->calculateId))
			{
				//lo($_REQUEST);
