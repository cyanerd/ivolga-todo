...
|---|--------|------------|----------|
| 1 | Медленная загрузка каталога | Готово (lazy-load слайдов + оптимизация картинок) | КРИТ, нужно срочно |
| 2 | Разные фото каталог/избранное | Готово | ОК |
| 3 | Баги в избранном | Готово | ОК |
| 4 | Прямые эфиры | Неактуально | ОК |
| 5 | Мультивыбор категорий | **Не сделано (~4ч)** | Не скорректирован |
...
| 12 | Дубль тех. названия | Готово (частично, 1 товар) | Пропало описание товара! |
